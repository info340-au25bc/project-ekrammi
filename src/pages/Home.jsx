...
export default function Home(){
    return (
        ...
        <section className="corelab-intro">
            <h1 className="title"> CoreLab Pilates </h1>
            <p>Seattle's Best interactive pilates studio for strength, Community and Confidence</p>
        ...
        <section className="why-corelab">
            <div className="why-core">
                ...
                <div className="why-2">
                    ...
                    <p><strong>No judgment, just progress</strong></p>
                </div>
